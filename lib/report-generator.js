 ...
 */
function generateReport(data, options, done) {
  if (data === undefined) {
  ...
  var outputPath = path.join(rootDirectory, DATA_PATH);
      output = 'var ' + generateReport.MOCHA_TEST_DATA_VAR_NAME + ' = ' +
 ...
 * @type {String}
 */
generateReport.MOCHA_TEST_DATA_VAR_NAME = 'data';
